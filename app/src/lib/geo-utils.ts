/**
 * Geographic Utilities for Medicare Coverage
 *
 * Maps ZIP codes to states and Medicare Administrative Contractors (MACs).
 * Used for regional LCD lookups and provider searches.
 */

// ZIP code prefix to state mapping
// First 3 digits of ZIP code indicate the region
...
// Part A/B MACs as of 2024
const STATE_TO_MAC: Record<string, { name: string; jurisdiction: string }> = {
  // Jurisdiction 1 (JN) - Novitas Solutions
  "CA": { name: "Noridian Healthcare Solutions", jurisdiction: "JE" },
  "NV": { name: "Noridian Healthcare Solutions", jurisdiction: "JE" },
  "AZ": { name: "Noridian Healthcare Solutions", jurisdiction: "JE" },
  "HI": { name: "Noridian Healthcare Solutions", jurisdiction: "JE" },
  "AS": { name: "Noridian Healthcare Solutions", jurisdiction: "JE" },
  "GU": { name: "Noridian Healthcare Solutions", jurisdiction: "JE" },
  "MP": { name: "Noridian Healthcare Solutions", jurisdiction: "JE" },

  // Jurisdiction F (JF) - Noridian (Northwest)
  "AK": { name: "Noridian Healthcare Solutions", jurisdiction: "JF" },
  "WA": { name: "Noridian Healthcare Solutions", jurisdiction: "JF" },
  "OR": { name: "Noridian Healthcare Solutions", jurisdiction: "JF" },
  "ID": { name: "Noridian Healthcare Solutions", jurisdiction: "JF" },
  "MT": { name: "Noridian Healthcare Solutions", jurisdiction: "JF" },
  "ND": { name: "Noridian Healthcare Solutions", jurisdiction: "JF" },
  "SD": { name: "Noridian Healthcare Solutions", jurisdiction: "JF" },
  "WY": { name: "Noridian Healthcare Solutions", jurisdiction: "JF" },
  "UT": { name: "Noridian Healthcare Solutions", jurisdiction: "JF" },

  // Jurisdiction 5 (J5) - Wisconsin Physicians Service (WPS)
  "IA": { name: "WPS Government Health Administrators", jurisdiction: "J5" },
  "KS": { name: "WPS Government Health Administrators", jurisdiction: "J5" },
  "MO": { name: "WPS Government Health Administrators", jurisdiction: "J5" },
  "NE": { name: "WPS Government Health Administrators", jurisdiction: "J5" },

  // Jurisdiction 6 (J6) - NGS
  "IL": { name: "National Government Services (NGS)", jurisdiction: "J6" },
  "MN": { name: "National Government Services (NGS)", jurisdiction: "J6" },
  "WI": { name: "National Government Services (NGS)", jurisdiction: "J6" },

  // Jurisdiction 8 (J8) - WPS
  "IN": { name: "WPS Government Health Administrators", jurisdiction: "J8" },
  "MI": { name: "WPS Government Health Administrators", jurisdiction: "J8" },

  // Jurisdiction H (JH) - Novitas Solutions
  "AR": { name: "Novitas Solutions", jurisdiction: "JH" },
  "CO": { name: "Novitas Solutions", jurisdiction: "JH" },
  "NM": { name: "Novitas Solutions", jurisdiction: "JH" },
  "OK": { name: "Novitas Solutions", jurisdiction: "JH" },
  "TX": { name: "Novitas Solutions", jurisdiction: "JH" },
  "LA": { name: "Novitas Solutions", jurisdiction: "JH" },
  "MS": { name: "Novitas Solutions", jurisdiction: "JH" },

  // Jurisdiction J (JJ) - Palmetto GBA
  "TN": { name: "Palmetto GBA", jurisdiction: "JJ" },
  "AL": { name: "Palmetto GBA", jurisdiction: "JJ" },
  "GA": { name: "Palmetto GBA", jurisdiction: "JJ" },

  // Jurisdiction M (JM) - Palmetto GBA
  "NC": { name: "Palmetto GBA", jurisdiction: "JM" },
  "SC": { name: "Palmetto GBA", jurisdiction: "JM" },
  "VA": { name: "Palmetto GBA", jurisdiction: "JM" },
  "WV": { name: "Palmetto GBA", jurisdiction: "JM" },

  // Jurisdiction N (JN) - First Coast Service Options
  "FL": { name: "First Coast Service Options", jurisdiction: "JN" },
  "PR": { name: "First Coast Service Options", jurisdiction: "JN" },
  "VI": { name: "First Coast Service Options", jurisdiction: "JN" },

  // Jurisdiction 9 (J9) - Novitas Solutions (originally PartB)
  "KY": { name: "CGS Administrators", jurisdiction: "15" },
  "OH": { name: "CGS Administrators", jurisdiction: "15" },

  // Jurisdiction L (JL) - Novitas Solutions
  "CT": { name: "Novitas Solutions", jurisdiction: "JL" },
  "NY": { name: "Novitas Solutions", jurisdiction: "JL" },
  "NJ": { name: "Novitas Solutions", jurisdiction: "JL" },
  "PA": { name: "Novitas Solutions", jurisdiction: "JL" },
  "DE": { name: "Novitas Solutions", jurisdiction: "JL" },
  "DC": { name: "Novitas Solutions", jurisdiction: "JL" },
  "MD": { name: "Novitas Solutions", jurisdiction: "JL" },

  // Jurisdiction K (JK) - NGS
  "ME": { name: "National Government Services (NGS)", jurisdiction: "JK" },
  "NH": { name: "National Government Services (NGS)", jurisdiction: "JK" },
  "VT": { name: "National Government Services (NGS)", jurisdiction: "JK" },
  "MA": { name: "National Government Services (NGS)", jurisdiction: "JK" },
  "RI": { name: "National Government Services (NGS)", jurisdiction: "JK" },
};

/**
 * Map a ZIP code to a state abbreviation
...
export function zipToState(zip: string): string | null {
  ...
  // Get the first 3 digits (ZIP prefix)
  const prefix = zip.substring(0, 3);
  return ZIP_PREFIX_TO_STATE[prefix] || null;
}

/**
 * Get the Medicare Administrative Contractor (MAC) for a state
 * @param state - Two-letter state code
 * @returns MAC information or default if not found
 */
export function getRegionalMAC(state: string): { name: string; jurisdiction: string } {
  const upperState = state.toUpperCase();
  return STATE_TO_MAC[upperState] || { name: "Unknown", jurisdiction: "Unknown" };
}

/**
 * Get state and MAC info from a ZIP code
 * @param zip - 5-digit ZIP code
 * @returns Object with state and MAC info
 */
export function getLocationInfo(zip: string): {
  state: string | null;
  mac: { name: string; jurisdiction: string } | null;
} {
  const state = zipToState(zip);
  if (!state) {
    return { state: null, mac: null };
  }
  return {
    state,
    mac: getRegionalMAC(state),
  };
}
 ...
 */
export function formatLocationInfo(zip: string): string {
  const info = getLocationInfo(zip);
  if (!info.state) {
  ...
  return `${info.state} (${info.mac.name})`;
}
