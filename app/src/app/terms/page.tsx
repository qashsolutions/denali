...
const SECTIONS = [
  ...
  },
  {
    ...
    paragraphs: [
      "All responses are generated by artificial intelligence (Claude by Anthropic). While our AI references real Medicare policies (LCD/NCD), clinical evidence (PubMed), and standardized medical codes, it is not a substitute for professional medical, legal, or financial advice.",
    ],
    items: [
