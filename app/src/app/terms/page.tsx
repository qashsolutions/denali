...
const SECTIONS = [
  ...
  },
  {
    ...
    paragraphs: [
      "As a Medicare beneficiary using the Medicare APIs through our Service, you have the following rights with respect to your data:",
    ],
    items: [
