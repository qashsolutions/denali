      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <Section title="Our Commitment">
          <P>
            ...
            Information (PHI) in compliance with the Health Insurance
        ...
        <Section title="Protected Health Information (PHI)">
          <P>
            When you connect your Medicare account via the official Medicare
            claims API, we may access the following categories of PHI:
          </P>
          <UL>
            <li>
              Patient demographics (age and gender only — we do not store full
              names, dates of birth, addresses, or Medicare beneficiary IDs)
            </li>
            <li>Medicare enrollment and coverage details</li>
            <li>Claims and Explanation of Benefits (EOBs)</li>
            <li>
              Conditions, medications, and screenings (extracted from claims
              data — lab values are not directly available from Medicare)
            </li>
          </UL>
          <P>
            This data is accessed only with your explicit authorization through
            the Medicare OAuth process. You control this connection and can
        ...
        <Section title="How We Use and Disclose PHI">
          <SubSection title="Permitted Uses">
            <UL>
              ...
              <li>
                <strong>At your request:</strong> Generating appeal letters that
                reference your specific diagnoses, procedures, and lab results
              </li>
            </UL>
          </SubSection>
        ...
        <Section title="Safeguards">
          <SubSection title="Technical Safeguards">
            <UL>
              ...
              <li>
                Application-level access controls ensuring users can only access
                their own records through authenticated API routes
              </li>
              <li>
          ...
          <SubSection title="Physical Safeguards">
            <UL>
              ...
              <li>Geographic access controls and network-level security</li>
            </UL>
          </SubSection>
        </Section>
        ...
        <Section title="Your Rights Under HIPAA">
          ...
          <UL>
            ...
            <li>
              ...
              with the U.S. Department of Health and Human Services (HHS) Office
              for Civil Rights
            </li>
          </UL>
        </Section>
        ...
        <Section title="Breach Notification">
          ...
          <UL>
            ...
            <li>Steps you can take to protect yourself from potential harm</li>
            <li>Contact information for further questions</li>
          </UL>
          <P>
            Breaches affecting 500 or more individuals will also be reported to
            the FTC and HHS as required by law, and where required, to the
            media.
          </P>
          <P>
            As a personal health record vendor, we also comply with the FTC
            Health Breach Notification Rule (16 CFR Part 318), which requires
            notification to affected individuals and, for breaches affecting 500
            or more individuals, notification to the FTC.
          </P>
        </Section>
        ...
        <Section title="Incident Response Plan">
          <P>
            Our incident response procedures follow the NIST SP 800-61 (Computer
            Security Incident Handling Guide) framework, adapted for healthcare
            data. The plan covers five phases:
          </P>
          ...
          <SubSection title="2. Containment">
            <UL>
              ...
              <li>
                Preservation of audit logs and system state for forensic
                analysis
              </li>
            </UL>
          </SubSection>
          ...
          <SubSection title="4. Notification">
            <UL>
              ...
              <li>
                FTC notified per the Health Breach Notification Rule (16 CFR
                Part 318) where applicable
              </li>
              <li>
          ...
          <SubSection title="5. Post-Incident Review">
            <UL>
              <li>Root cause analysis and documentation of lessons learned</li>
              <li>
        ...
        <Section title="Business Associates">
          ...
          <UL>
            <li>
              ...
              PostgreSQL), application hosting (ECS/Fargate), AI processing
              (Bedrock — runs Claude; health data only sent when user consents
              to Health Data in AI), and email delivery (SES). AWS is
              HIPAA-eligible. Our BAA with AWS was{" "}
              <strong>executed on February 25, 2026</strong>. AWS Bedrock does
              not store or log prompts and completions by default and does not
          ...
          <P>
            ...
            services that may come into contact with PHI (database, hosting, and
            AI processing).
          </P>
        </Section>
        ...
        <Section title="Minimum Necessary Standard">
          ...
          <UL>
            <li>
              Medicare API requests are scoped to specific FHIR resource types
              (Patient, Coverage, ExplanationOfBenefit)
            </li>
            <li>
              AI context injection includes only clinically relevant information
              (not raw FHIR bundles)
            </li>
            <li>
        ...
        <Section title="Policy Change Notification">
          ...
          <P>
            ...
            those changes and explain how they affect your Medicare data
            handling.
          </P>
          <P>
        ...
        <Section title="Privacy Officer Contact">
          ...
          <UL>
            ...
            <li>Organization: {BRAND.COMPANY_NAME}, HIPAA Privacy Officer</li>
          </UL>
          <P>
