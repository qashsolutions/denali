...
<!-- CLAUDE.md — Project instructions for Claude Code (the coding assistant).
     ...
     Last updated: 2026-02-24 (HIPAA page cross-audit)
     Maintainer: @cvr
-->
