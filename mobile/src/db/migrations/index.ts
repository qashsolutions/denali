...
/**
 * 002-reports-kept-status — add the 'kept' parse_status (CU-3, 2026-06-20).
 *
 * Rebuilds the reports table to expand the parse_status CHECK constraint
 * (SQLite can't ALTER a CHECK in place). Preserves all rows + the index.
 *
 * MIRROR of `src/db/migrations/002-reports-kept-status.sql`. Edit both.
 */
const M002_REPORTS_KEPT = `
