-- ============================================================================
-- Migration: Blog posts — ADD tags column + seed 10 initial posts
-- Converted from: scripts/migrate-blog.js on 2026-04-21
...
--
-- Idempotency: ADD COLUMN IF NOT EXISTS, ON CONFLICT (slug) DO NOTHING
-- ============================================================================

BEGIN;

-- Statement 1 (from ALTER_SQL): add tags column
ALTER TABLE blog_posts ADD COLUMN IF NOT EXISTS tags TEXT[] DEFAULT '{}';

-- Statement 2 (from SEED_SQL): seed 10 blog posts
INSERT INTO blog_posts (slug, title, kicker, key_message, body, category, cta_text, cta_url, sources, meta_title, meta_description, published, published_at) VALUES
...
-- Statement 3: total blog post count
SELECT COUNT(*) as total FROM blog_posts;

-- Statement 4: confirm tags column exists
SELECT column_name, data_type
FROM information_schema.columns
WHERE table_name = 'blog_posts' AND column_name = 'tags';

-- Statement 5: list all posts by category + slug
SELECT slug, category FROM blog_posts ORDER BY category, slug;
